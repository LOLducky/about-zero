...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "igotzeroideas — game dev" },
      {
        name: "description",
        content:
          "small site for a solo game dev. unity, learning unreal. open to collabs and jams.",
      },
    ],
  }),
  component: Home,
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* very subtle vignette + scanlines, dialed back */
        .v-vignette {
        ...
        <section className="hero">
          ...
          <aside className="about-box">
            ...
            <div className="about-row">
              ...
              <span className="v hi">igotzeroideas</span>
            </div>
            <div className="about-row">
              <span className="k">doing</span>
              <span className="v">solo game dev</span>
            </div>
            <div className="about-row">
              <span className="k">engine</span>
              <span className="v">unity (main), ue5 (learning)</span>
            </div>
            <div className="about-row">
              <span className="k">lang</span>
              <span className="v">c#, some blueprints, less c++</span>
            </div>
            <div className="about-row">
              <span className="k">years</span>
              <span className="v">3-ish</span>
            </div>
            <div className="about-row">
              <span className="k">status</span>
              <span className="v hi">open to collabs + jams</span>
            </div>
            <div className="about-row">
              <span className="k">coffee</span>
              <span className="v">too much</span>
            </div>
            <div className="about-foot">
              {`// TODO: replace this with something cooler`}
            </div>
          </aside>
        </section>
